...
毕设任务表
已完成
1.框架的搭建，使用git进行版本控制。将guns导入IDEA，并将项目托管在GitHub上。
（GitHub地址：https://github.com/workerbo/GraduationProject 附有Readme详细介绍）。  20:03 2019/2/16（F5快捷键）
2.业务流程分析，完成数据库文档的编辑。 10:31 2019/2/22
3.项目连接数据库，完成数据库脚本。
4.对项目进行初步修改，成功运行并将修改提交到GitHub。新建分支用于Demo实验。 17:17 2019/2/23
4.完成业务模块数据库表的设计。。 15:39 2019/2/24
5.完成后台七个模块页面和增删改查的搭建。    16:34 2019/3/2

任务规划
1.集成工作流框架flowable，完成业务流程控制。
2.利用Swegger给出具体接口文档。
3.权限和数据范围的设置，后台管理员页面美化。
4.论文初稿
5.阿里云完成部署，整体测试
...
以简洁为核心，抛弃了传统的易错，臃肿xml配置，采用javabean的方式配置spring，简化了项目的配置，如下示例为配置mybatis-plus和数据源:
```
@Configuration
